fertilizer_dic = {
        'NHigh': """<h2>The N value of soil is high and might give rise to weeds.</h2>
        ...
        'Nlow': """<h3>The N value of your soil is low.</h3>
        ...
        'PHigh': """<h3>The P value of your soil is high.</h3>
        <br/> Please consider the following suggestions:
        ...
        'Plow': """<h3>The P value of your soil is low.</h3>
        <br/> Please consider the following suggestions:
        ...
        'KHigh': """<h3> The K value of your soil is high </b></h3>
        <br/>Please consider following suggestions:<br/>
